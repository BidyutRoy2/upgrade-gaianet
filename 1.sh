...
##########################################################################################
#                                                                                        
#                🚀 THIS SCRIPT IS PROUDLY CREATED BY **HiddenGem**! 🚀                 
#                                                                                        
#   🌐 Join our revolution in decentralized networks and crypto innovation!               
#                                                                                        
# 📢 Stay updated:                                                                      
#     • Follow us on Telegram: https://t.me/hiddengemnews                           
#     • Follow us on X: https://x.com/0xaiexp                                      
##########################################################################################
...
if [[ $SYSTEM_TYPE -eq 0 ]]; then
    # VPS
    CONFIG_URL="https://raw.githubusercontent.com/BidyutRoy2/upgrade-gaianet/refs/heads/main/config2.json"
elif [[ $SYSTEM_TYPE -eq 1 ]]; then
    # Laptop
    if ! check_nvidia_gpu; then
        CONFIG_URL="https://raw.githubusercontent.com/BidyutRoy2/upgrade-gaianet/refs/heads/main/config2.json"
    else
        CONFIG_URL="https://raw.githubusercontent.com/BidyutRoy2/upgrade-gaianet/refs/heads/main/config1.json"
    fi
    ...
    if ! check_nvidia_gpu; then
        ...
        CONFIG_URL="https://raw.githubusercontent.com/BidyutRoy2/upgrade-gaianet/refs/heads/main/config3.json"
    fi
fi
...
echo "🌟 Stay connected: Telegram: https://t.me/hiddengemnews | Twitter: https://x.com/0xaiexp"
